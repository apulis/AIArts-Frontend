export default {
  ...
  'modelCreate.value.upload.tips': 'Please click or drag the file to upload',
  'modelCreate.value.upload.tips.desc': 'Only files uploaded in.zip,.tar, and.tar.gz are supported',
