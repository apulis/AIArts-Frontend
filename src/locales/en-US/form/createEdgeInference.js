export default {
  'edgeInferenceJobCreate.label.jobName': 'FD Server URL',
  ...
  'edgeInferenceJobCreate.label.transformParams': 'Transform Params',

  'edgeInferenceJobCreate.placeholder.inputInferenceName': 'Please Input FD Server URL',
  'edgeInferenceJobCreate.placeholder.selectType': 'Please Select Type',
  'edgeInferenceJobCreate.placeholder.inputInputPath': 'Please Input Input Path',
  ...
  'edgeInferenceJobCreate.rule.needName': 'Please Input FD Server URL！',
